...
exports.verify = function(jwtString, options, callback) {
    ...
    var version = aadManager.getVersion(jwtString);
    ...
    aadManager.requestOpenIdConfig(tenantId, version, function(err, openIdConfig) {
        ...
        aadManager.requestSigningCertificates(openIdConfig.jwks_uri, options, function(err, certificates) {
            ...
            aadManager.verify(jwtString, certificates, options, version, callback);
        })
    });
}
